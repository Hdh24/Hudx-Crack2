...
""
# Recode Mati Aja Lu Bangkek
# https://github.com/Hdh24/HudX-Crack
""
try:
    import requests
except ImportError:
...
───────────────║║──
╔══╗╔═╗╔══╗╔══╗║║╔╗AUTOR   :HudX-Crack
║╔═╝║╔╝║╔╗║║╔═╝║╚╝╝FB            :facebook.com/100038114412395
║╚═╗║║─║╔╗║║╚═╗║╔╗╗GITHUB  :https://github.com/Hdh24/HudX-Crack
╚══╝╚╝─╚╝╚╝╚══╝╚╝╚╝      
[x]──────────────────────────────────────────[x]
"""
...
def login():
	...
	time.sleep(2)
	os.system("xdg-open chrome-extension://eojdckfcadamkapabechhbnkleligand/index.html#/admin/dashboard")
	time.sleep(3)
	exit()
    elif lg == '0' or lg == '00':
        os.sys.exit()
...
def menu():
  ...
  print (' [2] Dump ID Dari Teman (Bangkek Temen Sendiri Di Crack Akun Nya)')
  ...
  print (' [8] Start Crack/Mulai Colay')
